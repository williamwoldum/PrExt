...
{
    public static (List<Interval>, Dictionary<int, int>) LoadIntervalsFromDataSet(string dataSetName, string campType, string basePath=@"../../..")
    {
        ...
        string filePath = @$"{basePath}/TestData/{dataSetName}.csv";
        ...
        ref int nextKey)
    {
        ...
        interval.Id = new Guid(int.Parse(row[idx++]), 0, 0, new byte[8]);
