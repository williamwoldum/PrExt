...
{
    public static async Task<List<Interval>> FitIntervals(List<Interval> intervals, Dictionary<int, int> colorMap,  List<Interval>? inclusions=null,
        int timeoutInSecs = 2)
    {
        var task = Task.Run(() => Prext(intervals, colorMap, inclusions));
    ...
    public static List<Interval> Prext(List<Interval> intervals, Dictionary<int, int> colorMap, List<Interval>? inclusions=null)
    {
